...
public class HorrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("horror");
        list=new ArrayList<>();
...
//                    }
                    ...
                    layoutManager = new LinearLayoutManager(HorrorActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(HorrorActivity.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
